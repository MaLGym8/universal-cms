...
function Add_Cms()
{
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        Наименование CMS:<br/>
        <input type="text" name="namecms" value=""/><br />
    ...
    echo'</select>
        ...
        <input type="submit" name="add_cms" value="Добавить" >
    </form>
...
if(isset($_POST["add_cms"]))
{
    ...
    mysql_query("INSERT INTO `cms` (`title`,`meta_d`,`meta_k`,`desc`,`image`,`parent`,`position`,`url`,`menu`,`h1`,`cms_name`) VALUES ('$title','$meta_d','$meta_k','$desc','$thumb','$parent','$position','$url','$menu','$h1','$namecms')");

    $_SESSION["message"] = "CMS добавлена";

        ...
        <div class="module_content">
            ...
            <form enctype="multipart/form-data" name="form" id="forma" method="post" action="">
                ...
                <div style="float:right; width:50%;">
                    ...
                    <p>
                        <label>Описание2<br>
                            <input value="" type="text" name="dop_text" style="width:70%;">
                        </label>
                    </p>
...
if(isset($_POST["add_portfolio"]))
{
    ...
    mysql_query ("INSERT INTO portfolio_item (title,meta_d,meta_k,url,`name`,`text`,`public_text`,`dop_text`,`iframe`,`h1`,`sort`,`public`,`background_color`,`background_text`,`portfolio_cat`) VALUES ('$title','$meta_d','$meta_k','$url','$name','$text','$public_text','$dop_text','$iframe','$h1','$position','$public','$background_color','$background_text','$cat')");

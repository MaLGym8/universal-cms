...
function Add_Type_Site()
{
    echo '
    <article class="module width_full">
    <header><h3>Добавление типа сайта</h3></header>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        Тип сайта:<br/>
        <input type="text" name="typesite" value=""/><br />
    ...
    echo'</select>
        ...
        <input type="submit" name="add_type_site" value="Добавить" >
    </form>
...
if(isset($_POST["add_type_site"]))
{
    ...
    mysql_query("INSERT INTO `type_site` (`title`,`meta_d`,`meta_k`,`desc`,`image`,`parent`,`position`,`url`,`menu`,`h1`,`type_site`) VALUES ('$title','$meta_d','$meta_k','$desc','$thumb','$parent','$position','$url','$menu','$h1','$type_site')");

    $_SESSION["message"] = "Тип сайта добавлен";
